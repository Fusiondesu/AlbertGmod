...
public class BronzeCoinItem extends ArbiononlineModElements.ModElement {
	@ObjectHolder("arbiononline:bronze_coin")
	public static final Item block = null;

	public BronzeCoinItem(ArbiononlineModElements instance) {
		super(instance, 6);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("100 Bronze Coins make 1Silver Coin!"));
		}
	}
}
